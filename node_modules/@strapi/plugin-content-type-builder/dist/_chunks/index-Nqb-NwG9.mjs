...
const ListView$1 = lazy(() => import("./ListView-hTZHNWZe.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-hTZHNWZe.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-Nqb-NwG9.mjs.map
