...
const useWebhooks = require("./useWebhooks-Kl-tmYja.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-xH7edKUr.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-PAogtX0Q.js.map
