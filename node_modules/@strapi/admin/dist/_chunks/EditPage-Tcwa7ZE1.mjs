...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-qPCHH_cv.mjs";
...
import { u as useWebhooks } from "./useWebhooks-YXlpOzjH.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-Zm6QlJIa.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Tcwa7ZE1.mjs.map
