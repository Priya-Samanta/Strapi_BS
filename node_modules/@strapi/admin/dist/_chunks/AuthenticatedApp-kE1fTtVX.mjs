...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-qPCHH_cv.mjs";
...
const dependencies = {
  ...
  "@strapi/provider-audit-logs-local": "4.25.4",
  "@strapi/types": "4.25.4",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.4",
...
const CM = React.lazy(
  () => import("./index-qPCHH_cv.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-W_mGV_CH.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-c4XTcYSx.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-HBVVS-TT.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-qPCHH_cv.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-qq-QYNSb.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-y2aDk8-3.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-kE1fTtVX.mjs.map
